...
class seven_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        run.setOnClickListener { view: View ->
            ...
            if(text1.text.isDigitsOnly() and text2.text.isDigitsOnly() and text3.text.isDigitsOnly() and text4.text.isDigitsOnly() and text5.text.isDigitsOnly() and text6.text.isDigitsOnly() and text7.text.isDigitsOnly()){
                ...
                val arr : IntArray = intArrayOf(input1, input2 , input3 , input4 , input5 , input6 , input7)
