...
class five_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        run.setOnClickListener { view: View ->
            ...
            if(text1.text.isDigitsOnly() and text2.text.isDigitsOnly() and text3.text.isDigitsOnly() and text4.text.isDigitsOnly() and text5.text.isDigitsOnly()){
